...
set volume_forecast;
by Agency;
where Agency in ('Agency_03', 'Agency_07', 'Agency_09', 'Agency_12', 'Agency_27', 'Agency_38', 'Agency_46', 'Agency_48', 'Agency_49', 'Agency_51', 'Agency_55', 'Agency_56', 'Agency_57', 'Agency_60');
retain cnt;
...
outfile='/folders/myfolders/rg/out_sku.csv' dbms=csv replace;
run;